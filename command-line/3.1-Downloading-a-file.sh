...
Status Code = 200
without https:// = HTTP/1.1 301 Moved Permanently
...
# 4. Suppose you wanted to list the files and directories using human-readable byte counts, all, by reverse time-sorted long-form. What command would you use? Why might this command be the personal favorite of the author of this tutorial?
ls -rtl -h *
It lists everything, even hidden files.
